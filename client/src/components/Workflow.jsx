import { FaRegClipboard, FaCogs, FaSearch } from "react-icons/fa";
  ...
  return (
    <section className="bg-gray-100 dark:bg-gray-900 py-12">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 dark:text-slate-300 mb-8">
          Optimize Your Workflow
        </h2>
        <p className="text-lg text-center text-gray-600 dark:text-gray-400 mb-12">
          Simplify issue tracking with powerful features designed to improve
