  ...
  return (
    <section className="py-16 bg-slate-50 dark:bg-slate-800">
      <div className="container mx-auto px-6 lg:px-8 text-center">
        <h2 className="text-4xl font-extrabold mb-4 text-slate-700 dark:text-slate-200">Ready to Streamline Your GitHub Issue Management?</h2>
        <p className="text-lg mb-8 text-slate-900 dark:text-slate-400">
          Enhance your workflow and keep your projects on track with <span className='text-slate-700 dark:text-slate-400 font-bold'>Issue Quest</span>. Get started and see how it can transform the way you manage GitHub issues.
        </p>
